...
import am.banking.system.user.infrastructure.adapter.out.persistence.converter.PermissionEnumReadConverter;
import am.banking.system.user.infrastructure.adapter.out.persistence.converter.PermissionEnumWriteConverter;
import am.banking.system.user.infrastructure.adapter.out.persistence.converter.RoleEnumReadConverter;
import am.banking.system.user.infrastructure.adapter.out.persistence.converter.RoleEnumWriteConverter;
